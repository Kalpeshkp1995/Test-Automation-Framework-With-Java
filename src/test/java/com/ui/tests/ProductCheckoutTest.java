...
public class ProductCheckoutTest extends TestBase {
	...
	public void setup() {
		searchResultPage = homePage.goToLoginPage().doLoginWith("timotoj174@asaption.com", "Password")
	...
	String result=	searchResultPage.clickOnProductAtIndex(2).changeSize(L).addProductToCart().proceedToCheckout().goToConfirmAddressPage().goToShipmentPage()
